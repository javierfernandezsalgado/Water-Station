...
void app_main(void)
{
    ...
    print_banner("Running tests with [nominal] tag");
    UNITY_BEGIN();
    unity_run_tests_by_tag("[parameters]", false);
    UNITY_END();

    print_banner("Running tests with [acql] tag");
    UNITY_BEGIN();
    unity_run_tests_by_tag("[acq]", false);
    UNITY_END();

    print_banner("Running tests with [event] tag");
    UNITY_BEGIN();
